    ...
    <header className="sticky top-0 z-30 bg-surface border-b-2 border-ink">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <a
            href="#workshop"
            className="inline-flex items-center px-4 py-2 text-xs font-bold uppercase tracking-wide text-white bg-primary border-2 border-ink shadow-[4px_4px_0_0_#000] hover:bg-primary-dark transition-colors"
          >
            Workshop
          </a>
        </div>
